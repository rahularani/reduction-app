...
const VolunteerNotificationDropdown = () => {
  ...
  const { notifications, unreadCount, markAsRead, markAllAsRead, clearNotifications } = useVolunteerNotificationStore()
...
export default VolunteerNotificationDropdown
